# Persian Mobile Date and Time Picker (Shadcn Edition)

This library provides a modern Persian mobile date picker component built with Shadcn Drawer (Vaul). It allows users to set year, month, day, hour, minute and second by sliding up or down.

**✨ New Features:**
- Built with Shadcn Drawer (Vaul) for better UX
- Updated to latest React 18 and modern dependencies
...
Using [npm](https://www.npmjs.com/):
    ...
    $ npm install --save persian-datepicker-shadcn

Using [yarn](https://yarnpkg.com):

    $ yarn add --save persian-datepicker-shadcn

Using [pnpm](https://pnpm.io):

    $ pnpm add persian-datepicker-shadcn

### Requirements

- React 18.0.0 or higher
- React DOM 18.0.0 or higher
- Framer Motion 11.0.0 or higher (peer dependency)
...
import {
  ...
  newDate,
  DatePickerConfig,
} from 'persian-datepicker-shadcn';
```
...
```javascript
import { newDate } from 'persian-datepicker-shadcn';
...
```javascript
import { convertDateInstanceToDateObject } from 'persian-datepicker-shadcn';
...
```javascript
import { daysInMonth } from 'persian-datepicker-shadcn';
...
```javascript
import { getWeekDay } from 'persian-datepicker-shadcn';
...
```javascript
import { getDayOfYear } from 'persian-datepicker-shadcn';
...
```javascript
import { isWeekend } from 'persian-datepicker-shadcn';
...
```javascript
import { getWeekDayText } from 'persian-datepicker-shadcn';
...
```javascript
import { isValidJalaaliDate } from 'persian-datepicker-shadcn';
...
```javascript
import { isBefore, newDate } from 'persian-datepicker-shadcn';
...
```javascript
import { isAfter, newDate } from 'persian-datepicker-shadcn';
...
```javascript
import { format } from 'persian-datepicker-shadcn';
...
```javascript
import { isEqual, newDate } from 'persian-datepicker-shadcn';
...
```javascript
import { getCurrentYear } from 'persian-datepicker-shadcn';
...
```javascript
import { currentDateObject } from 'persian-datepicker-shadcn';
...
```javascript
import { isLeapYear } from 'persian-datepicker-shadcn';
